...
const SEFER_TOUR_STEPS = window.SEFER_TOUR_STEPS = [
  { sel:'.brand-block, #nav-header-row .brand-block', title:'1. SEFER', text:'Marca SEFER ספר y la firma BY LWM PDC. Haz clic aquí para reiniciar la navegación (contraer todo).' },
  { sel:'#nav-header-actions', title:'2. Barra de acciones', text:'Perfil, nube y pantalla completa.' },
